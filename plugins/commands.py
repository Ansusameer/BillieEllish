...
from info import CHANNELS , ADMINS , AUTH_CHANNEL , LOG_CHANNEL , PICS , BATCH_FILE_CAPTION , CUSTOM_FILE_CAPTION , \
    PROTECT_CONTENT , CHNL_LNK , GRP_LNK , REQST_CHANNEL , SUPPORT_CHAT_ID , SUPPORT_CHAT , MAX_B_TN , VERIFY , \
    SHORTLINK_API , SHORTLINK_URL , DWLD , TUTORIAL , IS_TUTORIAL , PREMIUM_USER
from utils import get_settings , get_size , is_subscribed , save_group_settings , temp , verify_user , check_token , \
    check_verification , get_token , get_shortlink , get_tutorial
    ...
    if message.chat.type in [enums.ChatType.GROUP , enums.ChatType.SUPERGROUP]:
        ...
        await message.reply(
            script.START_TXT.format(message.from_user.mention if message.from_user else message.chat.title ,
                                    temp.U_NAME , temp.B_NAME) , reply_markup=reply_markup ,
    ...
    if AUTH_CHANNEL and not await is_subscribed(client , message):
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton("🔆彡[ AVAFLiX ]彡🔆" , url=invite_link.invite_link)])
...
async def shortlink(bot , message):
    ...
    try:
        ...
        return await message.reply_text(
            "<b>Wrong Format. Example - /shortlink omnifly.in 1f1da5c9df9a58058672ac8d8134e203b03426a1</b>")
